...
function initRuntimeSocketService() {
  const hosts = "10.14.64.172,127.0.0.1";
  const port = "8090";
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","10.14.64.172"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","E:/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"yy-planb","spaceId":"mp-7845ee5f-4c0e-4dd4-8a68-4c2a691871ea","clientSecret":"urePeVQGgnweweMv8H/IxA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__40F5868";
} catch (e2) {
